package com.dekhke.app.fragments;
...
import com.dekhke.app.adapters.AdapterDrawer;
import com.dekhke.app.adapters.ExpandableListAdapter;
import com.dekhke.app.materialtest.MyApplication;
import com.dekhke.app.pojo.Information;
...
public class FragmentDrawer extends Fragment {
   ...
   // private RecyclerView mRecyclerDrawer;
    ...
    /*Method to add data into the drawer list*/
//    public List<Information> getData() {
//        //load only static data inside a drawer
//        List<Information> data = new ArrayList<>();
//        int[] icons = {R.drawable.ic_action_phone_orange, R.drawable.ic_action_tv_orange, R.drawable.ic_action_coffee_orange};
